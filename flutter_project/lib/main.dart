...
void main() async {
  ...
  final keyApplicationId = 'L8Z3Tg7HYRms2Cr4ghziuqePiYf6MekwOLSs5ZBV';
  final keyClientKey = 'z35A397rwVcKl2X6y2mRd7hZjmHxLYOLzgpZjNbJ';
  final keyParseServerUrl = 'https://parseapi.back4app.com';

  await Parse().initialize(keyApplicationId, keyParseServerUrl, clientKey: keyClientKey, autoSendSessionId: true,
  liveQueryUrl: 'bitswilp2022mt93226.b4a.io', debug: true);
